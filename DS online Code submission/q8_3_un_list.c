...
int main(int argc, char const *argv[])
{
    ...
    addedge(0, 1), addedge(1, 0), addedge(0, 3), addedge(3, 0), addedge(0, 4), addedge(4, 0), addedge(1, 2), addedge(2, 1), addedge(1, 4), addedge(4, 1), addedge(2, 4), addedge(4, 2), addedge(2, 5), addedge(5, 2);
    addedge(3, 4), addedge(4, 3), addedge(3, 6), addedge(6, 3), addedge(4, 5), addedge(5, 4), addedge(4, 6), addedge(6, 4), addedge(5, 6), addedge(6, 5);
    display();
    int choice;
    int v, sv, ev;
    do
